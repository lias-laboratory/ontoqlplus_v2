...
public class FrenchLanguageAction extends AbstractAction {
    ...
    protected String language_code = MariusQLHelper.FRENCH;
    
    protected MariusQLSession session;

    public FrenchLanguageAction(MariusQLSession s) {

	super("French", Environment.FRENCH_ICON);
	language_code = MariusQLHelper.FRENCH;
	session = s;
	...
	session.setReferenceLanguage(MariusQLHelper.FRENCH);
    }
